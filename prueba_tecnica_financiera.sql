-- =========================================================
-- Base de datos: prueba_tecnica_financiera (v2, ajustada al PDF)
-- Prueba técnica Java Spring Boot - Entidad Financiera
-- CRUD de clientes, cuentas (ahorros/corriente) y transacciones
-- =========================================================
...
-- ---------------------------------------------------------
-- Tabla: cuenta (ahorros o corriente, ligada a un cliente)
-- ---------------------------------------------------------
CREATE TABLE cuenta (
    ...
    CONSTRAINT chk_saldo_ahorro CHECK (tipo_cuenta <> 'CUENTA_AHORROS' OR saldo >= 0)
);
